...
func Page(global, session int) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		_, err = templBuffer.WriteString("</title><link rel=\"stylesheet\" href=\"/assets/css/bulma.min.css\"><link rel=\"icon\" type=\"image/png\" sizes=\"48x48\" href=\"/assets/favicon/favicon.ico\"><link rel=\"manifest\" href=\"/assets/favicon/site.webmanifest\"><script src=\"/assets/js/htmx.min.js\">")
		if err != nil {
			return err
		}
		var_12 := ``
